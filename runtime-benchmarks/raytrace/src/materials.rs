...
pub trait Material {
    fn scatter(&self, rng: &mut XorShiftRng, r_in: &Ray, rec: &Hit) -> Scatter;
}
...
impl Material for Lambertian {
    fn scatter(&self, rng: &mut XorShiftRng, _r_in: &Ray, hit: &Hit) -> Scatter {
...
impl Material for Metal {
    fn scatter(&self, rng: &mut XorShiftRng, r_in: &Ray, hit: &Hit) -> Scatter {
